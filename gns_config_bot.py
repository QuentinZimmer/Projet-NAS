...
class GNSConfigBot:
    """
    Copie les configurations générées (ex: configs_big_gen/R1.cfg)
    ...
    def __init__(self, configs_gen_dir: str, dynamips_dir: str):
    ...
    def auto_detect_router_map(self) -> dict:
        """
    ...
    @staticmethod
    def _clean_generated_config(text: str) -> str:
        """
        Nettoie la config générée :
        - supprime les lignes contenant uniquement 'end' (avec espaces)
        - strip global
        """
    ...
    def deploy_all(self, dry_run: bool = False) -> None:
    ...
    def deploy_router(self, router_name: str, dry_run: bool = False) -> None:
        ...
        cleaned = self._clean_generated_config(raw)
